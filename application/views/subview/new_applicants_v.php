									...
									<div class="col-md-10">
							            ...
							            <div class="form-group">
							             ...
							             <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
							                	...
							                	<div class="row">
							                		<div class="col-md-6">
							                			<input type="text" class="form-control input-sm numOnly"  data="req" placeholder="Ft." data-key="HeightFt">
							                		</div>
							                		<div class="col-md-6">
							                			<input type="text" class="form-control input-sm numOnly"  data="req" placeholder="In." data-key="HeightIn">
							                		</div>
							                	</div>
										...
										<div class="form-group">
											<div class="col-sm-2">
					                    		...
					                    		<input type="text" class="form-control input-sm numOnly" placeholder="" data-key="SssNo" maxlength="50">
											</div>

											<div class="col-sm-2">
						                		<label for="txtNick" class="control-label">TIN No.</label>
					                    		<input type="text" class="form-control input-sm numOnly" data="req" placeholder="" data-key="TinNo" maxlength="50">
											</div>

											<div class="col-sm-2">
							                	<label for="txtBday" class="control-label">Philhealth No.:</label>
							                    <input type="text" class="form-control input-sm numOnly" data="req" placeholder=""   data-key="PhilhealthNo">
							                </div>

							                <div class="col-sm-2">
						                		<label for="txtSuffix" class="control-label">Pag-ibig No.:</label>
					                    		<input type="text" class="form-control input-sm"  data="req" placeholder="" data-key="PagibigNo">
											</div>
										</div>
